...
class No extends Personagem
{
	...
	public No(Personagem x, No e, No d)
	{
...
class Arvore extends No
{
	...
	public No inserir(Personagem x, No i) throws Exception
	{
		...
		{
			throw new Exception("O elemento ja consta na arvore, nao e possivel inserir em duplicata.");
		}
		return i;
	}		
	...
	{
		boolean resp;
		//se for null, significa que nao encontrou o elemento
		if(i == null)
		{
			cont[0]++;			
...
public class arvoreb
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		Arq.openWrite("680715_arvoreBinaria.txt");
